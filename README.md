...
A web project created to demonstrate a autolux user experience and its core interface flows.

## Purpose

This repository was created as a practical project to explore the design and implementation of **AutoLux**. It can be used as a learning reference, a starting point for further development, or a demonstration of the related business workflow.
